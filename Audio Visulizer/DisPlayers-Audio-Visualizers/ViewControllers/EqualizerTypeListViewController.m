...
- (NSMutableArray*) tableViewData {
    if (!_tableViewData) {
        ...
        [_tableViewData addObject:[Equalizer createWithType: DPHistogram name: @"Histogram"]];
        [_tableViewData addObject:[Equalizer createWithType: DPRolling name: @"Rolling"]];
        [_tableViewData addObject:[Equalizer createWithType: DPRollingWave name: @"Rolling wave"]];
        [_tableViewData addObject:[Equalizer createWithType: DPFillWave name: @"Wave with fill graph"]];
        [_tableViewData addObject:[Equalizer createWithType: DPWave name: @"Wave"]];
        [_tableViewData addObject:[Equalizer createWithType: DPCircleWave name: @"Circle Wave"]];
    }
